...
var VidPlayer = {
  ...
  launchModalPlayer: function() {
    var expose = $("<div id='expose'></div>"),
        playerWindow = $("<div id='player_window'><div id='close_link'></div><iframe src='https://player.vimeo.com/video/50953039' width='640' height='360' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>");
