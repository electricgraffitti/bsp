...
var Forms = {
  ...
  validateSignupForm: function() {
    $("#new_purchase").ketchup();
    $("input[type='submit']", "#new_purchase").click(function(e) {
  ...
  sideBarCartPriceCalculator: function () {
    ...
    userInputs.on("keyup", function () {
      var newStudentTotal = (Utility.calculateInputValue($("#students"), 12)),
          newTeacherTotal = (Utility.calculateInputValue($("#teachers"), 20)),
          newTotal = newStudentTotal + newTeacherTotal;
